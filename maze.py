...
# Load sound effect
button_click_sound = pygame.mixer.Sound(r"path for Click_effect.mp3")
open_sound = pygame.mixer.Sound(r"path for Background_music.mp3")
open2_sound = pygame.mixer.Sound(r"path for open_effect.mp3")
# Load sound effect for final path (replace with your actual sound file)
final_path_sound = pygame.mixer.Sound(r"path for path_found.mp3")  # Replace with your sound file path
...
bg_image = Image.open(r"path for bg2.jpeg")  # Replace with your image file path
...
# Load and set the background image
bg_image_maze = Image.open(r"path for bg2.jpeg")  # Replace with your image file path
